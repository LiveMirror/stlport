...
D_TEST_EXE = ./eh_test_d.exe
NOSGI_TEST_EXE = ./eh_test_nosgi.exe
...
CXXFLAGS = -Wall -O ${STL_INCL} -I. ${CXX_EXTRA_FLAGS} -DEH_VECTOR_OPERATOR_NEW -Zcrtdll -Zmt
D_CXXFLAGS = -Wall -g -O ${STL_INCL} -I. ${CXX_EXTRA_FLAGS} -DEH_VECTOR_OPERATOR_NEW -D_STLP_DEBUG -D_STLP_USE_STATIC_LIB -Zcrtdll
