...
void _STLP_DECLSPEC _STLP_CALL __stl_throw_runtime_error(const char* __msg) _STLP_FUNCTION_THROWS;
void _STLP_DECLSPEC _STLP_CALL __stl_throw_range_error(const char* __msg) _STLP_FUNCTION_THROWS;
void _STLP_DECLSPEC _STLP_CALL __stl_throw_out_of_range(const char* __msg) _STLP_FUNCTION_THROWS;
void _STLP_DECLSPEC _STLP_CALL __stl_throw_length_error(const char* __msg) _STLP_FUNCTION_THROWS;
void _STLP_DECLSPEC _STLP_CALL __stl_throw_invalid_argument(const char* __msg) _STLP_FUNCTION_THROWS;
void _STLP_DECLSPEC _STLP_CALL __stl_throw_overflow_error(const char* __msg) _STLP_FUNCTION_THROWS;
_STLP_END_NAMESPACE
